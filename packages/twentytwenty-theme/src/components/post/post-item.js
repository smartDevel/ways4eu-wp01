...
const PostItem = ({
  ...
  //Default-Theme-Einstellung: Falls Excerpt existiert dann excerpt anzeigen, sonst kompletter content
  //const content = showExcerpt ? item.excerpt : item.content;

  //meine Einstellung: immer kompletten content auch im preview anzeigen
